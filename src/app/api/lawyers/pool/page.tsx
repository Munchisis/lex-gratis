    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Browse unassigned matters and claim one to take it on. Once you claim
          a matter it moves to your dashboard.
        </p>
      </div>
        ...
        <div className="space-y-4">
          {sorted.map((m) => {
            ...
            return (
              <div
                key={m._id}
                className={`card transition-all ${isClaimed ? "border-green-300 bg-green-50" : ""}`}
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div>
                    {/* Show client name only to give context — no contact details yet */}
